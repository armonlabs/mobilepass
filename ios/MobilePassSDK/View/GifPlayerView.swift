...
class GIFPlayerView: UIView {
    ...
    convenience init(gifName: String) {
       self.init()
        print("Create gif with name: \(gifName)")
    ...
    public func updateGif(gifName: String) {
        imageView.image = UIImage.gif(asset: gifName)
    }
}
...
struct GIFView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: GIFPlayerView, context: UIViewRepresentableContext<GIFView>) {
        uiView.updateGif(gifName: gifName)
    }
...
extension UIImage {
    ...
    public class func gif(asset: String) -> UIImage? {
        ...
        guard let dataAsset = NSDataAsset(name: asset, bundle: Bundle.init(for: PassFlowController.self)) else {
